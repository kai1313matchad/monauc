...
-- Dumping data for table monauc.mona_user: ~3 rows (approximately)
...
-- Dumping data for table monauc.mona_aucgame: ~2 rows (approximately)
...
-- Dumping structure for table monauc.mona_aucmember
...
-- Dumping data for table monauc.mona_aucmember: ~0 rows (approximately)
